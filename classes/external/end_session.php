...
/**
 * External function: end an active session early (student-initiated exit).
 *
...
class end_session extends external_api {
    ...
    /**
     * End the given session early at the student's request.
     *
    ...
    public static function execute(int $sessionid, int $cmid): array {
        ...
        [
            'sessionid' => $sessionid,
            'cmid'      => $cmid,
        ] = self::validate_parameters(self::execute_parameters(), compact('sessionid', 'cmid'));
